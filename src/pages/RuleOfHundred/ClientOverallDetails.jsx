...
const ClientOverallDetails = () => {
    const API_URL = `${BASE_URL}/api/default/default-parameters/ruleof100`;
    ...
    const fetchDefaultParams = async () => {
        try {
            ...
            const response = await axios.get(`${BASE_URL}/api/default/default-parameters/ruleof100`, {
                headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setTableData(response); // Store response in state
    ...
    //             default_parameters: {
    //                 id: 1,
    //                 _401k_balance: formData.clientDetails.balancefidility401k || null,
    //                 roth_balance: formData.clientDetails.balanceRoth || null,
    //                 _401k_contributions: formData.clientDetails.contributionfidility401k || null,
    //                 roth_contributions: formData.clientDetails.contributionRoth || null,
    //                 _401k_opt_in_age: formData.clientDetails.optinAgefidility401k || null,
    //                 roth_opt_in_age: formData.clientDetails.optinAgeRoth || null,
    //                 _401k_rate_of_return: formData.clientDetails.rorfidility401k || null,
    //                 roth_rate_of_return: null,
    //                 _401k_withdrawal_rate: formData.clientDetails.withdrawnRatefidility401k || null,
    //                 roth_withdrawal_rate: null,
    //                 _401k_inflation: formData.clientDetails.inflationfidility401k || null,
    //                 roth_inflation: formData.clientDetails.inflationRoth || null,
    //                 _401k_cola: formData.clientDetails.colafidility401k || null,
    //                 roth_cola: formData.clientDetails.colaRoth || null,
    //                 _401k_tax_rate: formData.clientDetails.taxRatefidility401k || null,
    //                 roth_tax_rate: formData.clientDetails.rmdRateRoth || null,
    //                 _401k_rmd_rate: formData.clientDetails.rmdRatefidility401k || null,
    //                 roth_rmd_rate: null,
    //                 _401k_rmd_age: formData.clientDetails.rmdAgefidility401k || null,
    //                 roth_rmd_age: formData.clientDetails.rmdAgeRoth || null,
    //                 _401k_flat_rate: formData.clientDetails.flatRatefidility401k || null,
    //                 roth_flat_rate: null,
    //                 _401k_flat_rate_age: formData.clientDetails.flatRateAgefidility401k || null,
    //                 roth_flat_rate_age: formData.clientDetails.flatRateAgeRoth || null,
    //                 _401k_bonus: formData.clientDetails.bonusfidility401k || null,
    //                 roth_bonus: formData.clientDetails.bonusRoth || null,
    //                 _401k_lump_sum: formData.clientDetails.balanceLumpSumfidility401k || null,
    //                 roth_lump_sum: null,
    //                 _401k_lump_sum_age: formData.clientDetails.lumpSumAgefidility401k || null,
    //                 roth_lump_sum_age: formData.clientDetails.lumpSumOptInAgeRoth || null,
    //             },
    //             financial_details: {
    //                 Name: formData.clientDetails.name || "",
    //                 Age: formData.clientDetails.age || null,
    //                 "Retirement Age": formData.clientDetails.retirementAge || null,
    //                 "Spouse Name": formData.spouseDetails.name || "",
    //                 "Spouse Age": formData.spouseDetails.age || null,
    //                 "Spouse Retirement Age": formData.spouseDetails.retirementAge || null,
    //                 "Total Investable Assets": formData.clientDetails.totalInvestableAssets || null,
    //                 "Income Goal": formData.clientDetails.incomeGoal || null,
    //                 Year: formData.clientDetails.year || null,
    //                 Income: {
    //                     Pension: formData.clientDetails.PensionIncome || null,
    //                     Salary: formData.clientDetails.otherIncome || null,
    //                     "Social Security": formData.clientDetails.socIncome || null,
    //                 },
    //             },
    //         };

    //         const response = await axios.put(
    //             `${BASE_URL}/api/default/default-parameters/ruleof100/`,
    //             requestData,
    //             {
    //                 headers: {
    //                     Authorization: `Bearer ${authUser.accessToken} `,
    ...
    const validateField = (name, value) => {
        ...
        //     value = value ? String(value) : ''; // Convert non-string values to string or set empty string
        // }
    ...
    const handleReset = () => {
        setFormData({
            clientDetails: {
                name: '', age: '', retirementAge: '', totalInvestableAssets: '', incomeGoal: '', year: '',
                socIncome: '', otherIncome: '', PensionIncome: '', epension: '',

                balancefidility401k: '', contributionfidility401k: '', optinAgefidility401k: '', rorfidility401k: '',
                withdrawnRatefidility401k: '', inflationfidility401k: '', colafidility401k: '', taxRatefidility401k: '',
                rmdRatefidility401k: '', rmdAgefidility401k: '', rmdAgeRoth: '',
                bonusfidility401k: '', bonusRoth: '', flatRatefidility401k: '', flatRateAgefidility401k: '', flatRateAgeRoth: '',
                balanceLumpSumfidility401k: '', lumpSumfidility401k: '', lumpSumAgefidility401k: '', lumpSumOptInAgeRoth: '',
                        ...
                        {/* <form onSubmit={handleSubmit} className='mb-3'> */}
                            ...
                            <Row>
                                <Col className='d-flex justify-content-center'>
                                    ...
                                    <Link to='/print-document'>

                                        <Button type="button" color="primary" className='ms-5'  >
                                            View and Print
                                        </Button>
                                    </Link>
                                </Col>
...
export default ClientOverallDetails;
