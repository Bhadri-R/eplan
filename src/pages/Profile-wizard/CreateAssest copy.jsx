...
const CreateAsset = () => {
    ...
    const handleCreateAsset = async (e) => {
        ...
        try {
            ...
            setTimeout(() => {
                setAssetData({ clientName: '', type: '', account: '', risk: '', currentBalance: '', contribution: '' });
                setErrors({});
                setLoading(false);
            }, 1000);
        } catch (error) {
                            ...
                            <form onSubmit={handleCreateAsset} className='mb-3'>
                                <Row>
                                    ...
                                    <Col md={4}>
                                        <FormGroup>
                                            <Label>Account</Label>
                                            <Input type="text" name="account" value={assetData.account} onChange={handleChange} invalid={!!errors.account} />
                                    ...
                                    <Col md={4}>
                                        <FormGroup>
                                            <Label>Risk</Label>
                                            <Input type="select" name="risk" value={assetData.risk} onChange={handleChange} invalid={!!errors.risk}>
                                    ...
                                    <Col md={4}>
                                        <FormGroup>
                                            ...
                                            <Input type="text" name="currentBalance" value={assetData.currentBalance} onChange={handleChange} invalid={!!errors.currentBalance} />
                                    ...
                                    <Col md={4}>
                                        <FormGroup>
                                            ...
                                            <Input type="text" name="contribution" value={assetData.contribution} onChange={handleChange} invalid={!!errors.contribution} />
