                    ...
                    <CardBody  >
                        <ResponsiveContainer width="100%" height={400}>
                            <BarChart data={data} margin={{ top: 20, right: 30, left: 20, bottom: 50 }}>
                                ...
                                <Legend />
                                <Bar dataKey="incomeGap" stackId="a" fill="#5B9E3D" name="Income Goal" />
                                <Bar dataKey="incomeGap" stackId="a" fill="#FF3030" name="Income Gap" />
                                <Bar dataKey="totalIncome" stackId="b" fill="#3B88E6" name="totalIncome Income" />
                            </BarChart>
                        </ResponsiveContainer>
                    </CardBody>
                </Card>
